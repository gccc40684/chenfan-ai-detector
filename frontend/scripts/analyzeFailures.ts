...
const humanFailures = [
  {
    id: 3,
    text: `刚看完那场球赛，太精彩了！最后几分钟真的是心跳加速。
   虽然支持的球队输了，但比赛过程真的很刺激。下次一定要现场看一次。`,
  },
  {
    id: 5,
    text: `周末去爬山了，腿现在还酸着呢。山顶的风景确实值得，空气也清新。
   就是下山的时候差点滑倒，吓出一身冷汗。`,
  },
];
...
const aiBorderline = [
  {
    id: 0,
    text: `Artificial intelligence is a significant branch of computer science.
  ...
  {
    id: 4,
    text: `Economic growth depends on multiple factors. Innovation drives productivity improvements.
