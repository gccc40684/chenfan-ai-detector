...
// 示例人工文本（中文）- 口语化、有情感、结构松散
export const sampleHumanChinese = [
...
// 示例 AI 文本（中文）- 结构规整、用词正式、模式化
export const sampleAIChinese = [
...
// 示例人工文本（英文）- 口语化、有语法变化、情感表达
export const sampleHumanEnglish = [
...
// 示例 AI 文本（英文）- 结构统一、用词正式
export const sampleAIEnglish = [
...
// 更多测试样本
export const additionalHumanChinese = [
...
export const additionalAIChinese = [
  `数字化转型是企业发展的必然趋势。企业需要积极拥抱新技术。
   云计算技术能够降低企业的IT成本。大数据分析有助于企业决策。
   人工智能技术可以提升企业运营效率。物联网技术实现了设备互联互通。`,
  `健康生活方式对每个人都至关重要。均衡饮食是保持健康的基础。
   适量运动能够增强体质。充足睡眠有助于身体恢复。
   心理健康同样不容忽视。定期体检可以及早发现健康问题。`,
  `城市化进程不断加快。城市人口持续增长。城市基础设施面临挑战。
   交通拥堵问题日益严重。环境污染需要引起重视。
   城市规划应当科学合理。智慧城市是未来的发展方向。`,
];

export const additionalHumanEnglish = [
...
export const additionalAIEnglish = [
