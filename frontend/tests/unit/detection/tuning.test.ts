...
describe('Algorithm Tuning', () => {
  ...
  it('should find optimal weights via grid search', () => {
    ...
    const configs: Partial<DetectorConfig>[] = [
      {
        weights: { burstiness: 0.15, diversity: 0.2, repetition: 0.15, sentenceVariation: 0.1, patternDensity: 0.4 },
        thresholds: { aiScore: 0.5, highConfidence: 0.75 },
      },
      {
        weights: { burstiness: 0.05, diversity: 0.3, repetition: 0.15, sentenceVariation: 0.25, patternDensity: 0.25 },
        thresholds: { aiScore: 0.52, highConfidence: 0.75 },
      },
      {
        weights: { burstiness: 0.1, diversity: 0.25, repetition: 0.15, sentenceVariation: 0.2, patternDensity: 0.3 },
        thresholds: { aiScore: 0.5, highConfidence: 0.75 },
      },
    ];
